...
/**
 * @Description 1.kafka comuser消费kafka中的person数据
 * 2.创建geomesa kafka DataStore
 * 3.将person数据添加到geomesa kafka feature中
 */
public class Test {
...
//                    System.out.println(record.value());
                    ...
                    double longitude = Double.parseDouble(a[2]);
                    double latitude = Double.parseDouble(a[3]);
